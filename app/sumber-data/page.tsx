...
export default function SumberDataPage() {
  const sources = [
    ...
    },
    {
      ...
      detail: "Sumber data jumlah penutur dan status vitalitas. Data paling akurat untuk bahasa-bahasa besar Indonesia.",
    ...
    },
    {
      icon: <DatabaseIcon />,
      title: "Glottolog",
      desc: "Database linguistik oleh Max Planck Institute",
      detail: "Digunakan untuk verifikasi rumpun bahasa, kode ISO 639-3, dan klasifikasi linguistik.",
    ...
    },
    {
      ...
      desc: "Ringkasan 3 paragraf per bahasa via qd/kmodel",
      detail: "Menggunakan 9Router AI gateway untuk menghasilkan ringkasan informatif dari data yang tersedia. Setiap bahasa mendapat summary unik.",
      url: null,
      coverage: "398 bahasa (100%)",
    },
    {
      icon: <CodeIcon />,
      title: "ISO 639-3 Registry",
      desc: "Standar kode bahasa internasional",
      detail: "Digunakan sebagai basis data awal untuk registrasi bahasa dengan kode ISO 639-3 yang valid.",
      url: "https://iso639-3.sil.org/",
      coverage: "700+ bahasa Indonesia terdaftar",
    },
  ];
